...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "2128790575:AAEgNFiHd2VKk-j2Abr7-KVtgRTgNfq0z7Q")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001707214877"))
...
# Username CH & Group
CHANNEL = os.environ.get("CHANNEL", "indonbest")
